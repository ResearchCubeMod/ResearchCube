...
### This project uses a modified version of the the "Don't Be a Jerk" License created by CoFH
...
- Create or distribute code that impersonates or recreates the purpose of this code
...
**A jerk is anyone who attempts to or intends to claim partial or total ownership of the original or repackaged code and/or attempts to or intends to redistribute original or repackaged code without prior express written permission from the owners (fireheart3911, MrSilly).
...
Copyright (c) 2024-2026 fireheart3911
