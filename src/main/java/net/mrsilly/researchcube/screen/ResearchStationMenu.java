package net.mrsilly.researchcube.screen;
...
import net.mrsilly.researchcube.screen.slot.ModResultSlot;
...
public class ResearchStationMenu extends AbstractContainerMenu {
    ...
    public ResearchStationMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(ModMenuTypes.RESEARCH_STATION_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((ResearchStationBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.RESEARCH_STATION.get());
    }
